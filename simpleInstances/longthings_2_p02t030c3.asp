...
thingLong(39).
legacyConfig(thing(40)).
thingLong(40).
legacyConfig(cabinet(9)).
legacyConfig(cabinetTOthing(9,31)).
legacyConfig(cabinetTOthing(9,32)).
legacyConfig(cabinetTOthing(9,33)).
legacyConfig(cabinetTOthing(9,34)).
legacyConfig(cabinetTOthing(9,35)).
legacyConfig(cabinet(10)).
legacyConfig(cabinetTOthing(10,36)).
legacyConfig(cabinetTOthing(10,37)).
legacyConfig(cabinetTOthing(10,38)).
legacyConfig(cabinetTOthing(10,39)).
legacyConfig(cabinetTOthing(10,40)).
...
legacyConfig(cabinetTOthing(6,20)).
legacyConfig(cabinet(7)).
legacyConfig(cabinetTOthing(7,21)).
legacyConfig(cabinetTOthing(7,22)).
legacyConfig(cabinetTOthing(7,23)).
legacyConfig(cabinetTOthing(7,24)).
legacyConfig(cabinetTOthing(7,25)).
legacyConfig(cabinet(8)).
legacyConfig(cabinetTOthing(8,26)).
legacyConfig(cabinetTOthing(8,27)).
legacyConfig(cabinetTOthing(8,28)).
legacyConfig(cabinetTOthing(8,29)).
legacyConfig(cabinetTOthing(8,30)).
...
legacyConfig(personTOthing(2,35)).
legacyConfig(personTOthing(2,36)).
legacyConfig(personTOthing(2,37)).
legacyConfig(personTOthing(2,38)).
legacyConfig(personTOthing(2,39)).
legacyConfig(personTOthing(2,40)).
% domains
cabinetDomainNew(500..523).
roomDomainNew(1000..1027).
% reuse costs
